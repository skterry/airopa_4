...
\begin{figure}[!h]
  %\hspace{-1.04cm}
  \subfloat{\includegraphics[width=0.33\textwidth]{Figures/BINNED_GQ_fvuPhotAstrom-ratio_errorbars.pdf}}
  \subfloat{\includegraphics[width=0.33\textwidth]{Figures/BINNED_AQ_fvuPhotAstrom-ratio_errorbars.pdf}}
   \subfloat{\includegraphics[width=0.33\textwidth]{Figures/BINNED_PQ_fvuPhotAstrom-ratio_errorbars.pdf}}
